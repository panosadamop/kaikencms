...
@RestController
@RequestMapping("/api/kaiken-cms-kafka")
public class KaikenCmsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(KaikenCmsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KaikenCmsKafkaResource(KafkaProperties kafkaProperties) {
